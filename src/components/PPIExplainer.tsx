export default function PPIExplainer() {
  return (
    <div
      id="ppi-vs-dpi"
      className="mt-12 scroll-mt-6 rounded-2xl border border-white/6 bg-app-card-surface px-6 py-6 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)]"
    >
      ...
      <div className="mb-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border border-white/6 bg-app-card-dark px-5 py-4">
          ...
          <p className="m-0 text-sm leading-relaxed text-zinc-400">
            Describes the <span className="text-zinc-200">digital file</span>.
            It's how many pixels exist per inch of the image at a given print
            size. Higher PPI means more detail is available for the printer to
            work with. This calculator computes the effective PPI of your file
            at each size.
          </p>
        </div>
        <div className="rounded-2xl border border-white/6 bg-app-card-dark px-5 py-4">
          ...
          <p className="m-0 text-sm leading-relaxed text-zinc-400">
            Describes the{" "}
            <span className="text-zinc-200">physical printer</span>. It's how
            many tiny ink dots the device lays down per inch of paper. A printer
            rated at 1440 DPI can place 1440 droplets per inch — far more than
            the 300 PPI typically needed from a source file.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-[10px] border border-app-card bg-app-card-dark px-5 py-4">
        ...
        <p className="m-0 text-sm leading-relaxed text-zinc-400">
          ...
          always much higher — it uses multiple ink dots to reproduce a single
          pixel of color, which is why a 1440 DPI printer still benefits from a
          300 PPI file. In short:{" "}
